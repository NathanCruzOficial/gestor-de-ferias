    ...
    if 'user' in session:
        for cliente in clientes:
            if cliente['username'] == session['user']:
                return render_template('cliente.html', cliente=cliente, ferias=ferias)
...
#     if 'admin' in session:
#         if session['nivel'] == 2:
#             # return render_template('admin_area.html', admins=admins)
#             return render_template('nivel_2.html', ferias=ferias)
#         elif session['nivel'] == 1:
#             return render_template('nivel_1.html', ferias=ferias)
#         elif session['nivel'] == 0:
